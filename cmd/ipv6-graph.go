...
func init() {
	...
	flag.StringVar(&inetPrefixV6, "inetv6-prefix-name", "inet_prefix_v6", "inet prefix v6 Collection name, default \"inet_prefix_v6\"")
	flag.StringVar(&lsv6Graph, "lsv6-graph", "lsv6_graph", "Edge Collection name, default \"lsv6_graph\"")
	flag.StringVar(&ipv6Graph, "ipv6-graph", "ipv6_graph", "Edge Collection name, default \"ipv6_graph\"")
}
...
func main() {
	...
	dbSrv, err := arangodb.NewDBSrvClient(dbSrvAddr, dbUser, dbPass, dbName, lslink,
		...
		inetPrefixV6, lsv6Graph, ipv6Graph, notifier)
	if err != nil {
