...
func init() {
	...
	flag.StringVar(&bgpV6Graph, "bgpv6-graph", "bgpv6_graph", "bgpv6_graph Collection name, default \"bgpv6_graph\"")
}
...
func main() {
	...
	dbSrv, err := arangodb.NewDBSrvClient(dbSrvAddr, dbUser, dbPass, dbName, peer,
		ebgpPeerV6, unicastprefixV6, ebgpprefixV6, inetprefixV6, bgpV6Graph, notifier)
	if err != nil {
